...
fb.views.PostUI = Backbone.View.extend({
    ...
    postMessage: function () {
        FB.ui(
            {
                method:'feed',
                name:'FBAPP Application',
                link:'#',
                picture:'/img/FBAPP.png',
                caption:'by Christophe Coenraets',
                description:'FBAPP is a simple application that shows how to use the Facebook JavaScript SDK and the Graph API.'
            },
            function (response) {
                if (response && response.id) {
                    alert('Your post was published.');
